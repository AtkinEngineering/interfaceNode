...
<!-- VERSION_INFO_START -->
![RC](https://img.shields.io/badge/RC-1.2.0--rc.4-blue)   
**Version:** `1.2.0-rc.4+2609261142`   
**Built:** `2026-09-26 11:42`   
**SDK:** `6.2.0-4d59230`   
**CMake:** `3.28.3`   
<!-- VERSION_INFO_END -->
...
- `network`: No WiFi mode - WiFi and all network services (TCP, WebSocket, beacon, mDNS) are switched off and the bridge runs between USB and RS485 only; configuration mode still uses the access point. Status LED shows cyan, WiFi LED off
...
- `settings`: An invalid WiFi mode was treated as station mode; it now falls back to the access point
...
**Firmware SHA-256:** `f82c547f367c8d1dffcb964251a3b414a6c3199dabc09f0ecff21af5a6a3e2fa`
<!-- FIRMWARE_SHA256_END -->
