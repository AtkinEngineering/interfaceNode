...
<!-- VERSION_INFO_START -->
![Beta](https://img.shields.io/badge/Beta-1.2.0--beta.1-yellow)   
**Version:** `1.2.0-beta.1+2609201115`   
**Built:** `2026-09-20 11:15`   
**SDK:** `6.2.0-e4df0c1`   
**CMake:** `4.0.3`   
<!-- VERSION_INFO_END -->
...
- `button`: Short press while already in configuration mode reboots back into operating mode - the button acts as a toggle between the two modes
...
**Firmware SHA-256:** `69458bb3033537f13249423fbecb72a9f33d182ce2f88c7442670574cdb1a1cd`
<!-- FIRMWARE_SHA256_END -->
...
- `protocol:` `DyNet` Websockets Dynet filter
